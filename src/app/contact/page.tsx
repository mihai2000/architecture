			...
			<Reveal delay={80} className="mb-16 grid gap-6 md:grid-cols-3">
				...
				>
					...
					<div className="mt-5 flex items-center justify-between gap-4">
						<p className="break-all text-lg font-medium text-zinc-900 transition-colors group-hover:text-zinc-600">
							{email}
						</p>

						<span className="shrink-0 text-xl text-zinc-400 opacity-0 transition-all duration-300 group-hover:translate-x-1 group-hover:opacity-100">
							↗
						</span>
					</div>
				</a>
